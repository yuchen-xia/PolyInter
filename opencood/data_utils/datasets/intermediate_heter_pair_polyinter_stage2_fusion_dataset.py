...
def getIntermediateheterpairpolyinterstage2FusionDataset(cls):
    """
    cls: the Basedataset.
    """
    class IntermediateheterPolyInterStage2FusionDataset(cls):
        ...
        def __getitem__(self, idx):
            ...
            assert len(neb_input_list) == len(neb_lidar_pose_lst)
    ...
    return IntermediateheterPolyInterStage2FusionDataset
